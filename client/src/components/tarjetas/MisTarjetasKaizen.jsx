...
export class MisTarjetasKaizen extends Component {
  componentDidMount() {
              ...
              <Container>
                ...
                <MaterialTable
                  ...
                  options={{
                    ...
                    pageSizeOptions: [10, 20, 100, tarjetaskaizen.length],
                    grouping: true,
                  }}
                  localization={{
                    pagination: {
                  ...
                  columns={[
                    ...
                    { title: "Código del Kaizen", field: "codigo" },
